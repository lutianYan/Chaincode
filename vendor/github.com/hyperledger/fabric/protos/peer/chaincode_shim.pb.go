...
const (
	...
	ChaincodeMessage_GET_KEY_FOR_KEY     ChaincodeMessage_Type = 20
)
...
type GetKeyForKey struct {
	Key string `protobuf:"bytes,1,opt,name=key" json:"key,omitempty"`
}
func (m *GetKeyForKey) Reset()                    { *m = GetKeyForKey{} }
func (m *GetKeyForKey) String() string            { return proto.CompactTextString(m) }
func (*GetKeyForKey) ProtoMessage()               {}
func (*GetKeyForKey) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{11} }
func (m *GetKeyForKey) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*GetKeyForKey)(nil), "protos.GetKeyForKey")
